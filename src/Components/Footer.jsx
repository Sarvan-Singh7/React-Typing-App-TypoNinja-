      ...
      <div className="actual-footer">
        ...
        <div className="themeButton">
          <Select                       //ye Select Component toh import kiya hai react-select npm se sara styles wagara le raha hai
              ...
              styles={{
                  control: (styles) => ({...styles,backgroundColor: theme.backgroundColor, // color of the select bar itself
                         }),
                   menu: (styles) => ({...styles,backgroundColor: theme.backgroundColor, // color of the dropdown menu
                        }),
